...
public class AddEmpDialog extends JDialog {
	...
	public AddEmpDialog(ManageEmpRegister mer) {
		...
		jlblAddr=new JLabel("주소");//시,구,동,상세정보
		...
		jlblHyphenEmail.setBounds(240, 90, 100, 50);
		jlblAddr.setBounds(30, 130, 100, 50);
		jlblSsn.setBounds(30, 170, 100, 50);
		jlblHyphenSsn.setBounds(240, 170, 100, 50);
		jlblDept.setBounds(30, 210, 100, 50);
		jlblTeam.setBounds(30, 250, 100, 50);
		jlblJob.setBounds(30, 290, 100, 50);
		jlblTel.setBounds(30, 330, 100, 50);
		jlblJobTel.setBounds(30, 370, 100, 50);
		jlblLevel.setBounds(30, 410, 100, 50);
		...
		jtfStartEmail.setBounds(130, 100, 100, 30);
		jtfEndEmail.setBounds(260, 100, 100, 30);
		jtfAddr.setBounds(130, 140, 100, 30);
		jtfStartSsn.setBounds(130, 180, 100, 30);
		jtfEndSsn.setBounds(260, 180, 100, 30);
		jtfDept.setBounds(130, 220, 100, 30);
		jtfTeam.setBounds(130, 260, 100, 30);
		jtfJob.setBounds(130, 300, 100, 30);
		jtfTel.setBounds(130, 340, 100, 30);
		jtfJobTel.setBounds(130, 380, 100, 30);
		jtfLevel.setBounds(130, 420, 100, 30);
		
		jcbYearHiredate.setBounds(400, 10, 100, 50);
		jcbMonthHiredate.setBounds(550, 10, 100, 50);
		jcbDayHiredate.setBounds(700, 10, 100, 50);
		
		jtfSal.setBounds(500, 140, 100, 30);
